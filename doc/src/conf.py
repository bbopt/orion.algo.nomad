# -*- coding: utf-8 -*-
#
# orion.algo.nomad documentation build configuration file.
#
...
import orion.algo.nomad as algo_plugin
...
texinfo_documents = [
  (master_doc, 'nomad',
   u'Oríon algo nomad Documentation',
   author, 'nomad', algo_plugin.__descr__,
   'Miscellaneous'),
]
